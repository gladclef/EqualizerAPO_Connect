...
{
    /// <summary>
    /// Taken/ from http://stackoverflow.com/questions/4890915/is-there-a-task-based-replacement-for-system-threading-timer/14945407#14945407.
    /// Why didn't I just use the Timer class? That's a great question. Here's a terrible answer: http://stackoverflow.com/questions/12555049/timer-in-portable-library
    ...
    public static class PeriodicTaskFactory
    {
                                                   ...
                                                   TaskCreationOptions periodicTaskCreationOptions)
        {
            ...
            {
                neverTrigger.WaitOne(delayInMilliseconds);
            }
